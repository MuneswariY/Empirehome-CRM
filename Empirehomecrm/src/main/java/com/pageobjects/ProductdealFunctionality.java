...
public class ProductdealFunctionality  extends Basetest{
   	...
   	public void customerregister() throws Throwable {
		...
		searchbox.sendKeys(prop.getProperty("FullName"));
   	...
   	public void verifysalesexecutiveaddcustomer(int prodsIndex, WebElement search, WebElement name) throws Throwable {
